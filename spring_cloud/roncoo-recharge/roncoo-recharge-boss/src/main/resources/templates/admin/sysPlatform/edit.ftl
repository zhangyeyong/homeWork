...
<div class="bjui-pageContent">
	<form action="${base}/admin/sysPlatform/update" data-toggle="validate" method="post">
		<input type="hidden" name="id" value="${bean.id}"/>
		<div class="form-group">
            <label class="control-label x85">平台名称：</label>
            <input type="text" name="platformName" value="${bean.platformName!}" placeholder="平台名称" size="20">
        </div>
		<div class="form-group">
