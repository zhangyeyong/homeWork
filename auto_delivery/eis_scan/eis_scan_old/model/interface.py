...
class GhEvsInterface:
    ...
    def Login(self, userCd, pwd, lang=None):
        ...
        rtnJson = '''
            ...
            "ftpMap":{"2000":{"ftpIp":"203.175.149.183","port":"21","userName":"xtsp","password":"1"},"2001":{"ftpIp":"203.175.149.183","port":"21","userName":"xtsp","password":"1"}},
    ...
    def FtpInfo(self, ticket, taskType, jsonParam):
        ...
        rtnJson = '''
            ...
            "status":"NORMAL",
            "reason":"不能上传的原因",
            "imagePath":"/zyy/image/2018/",
            "iconPath":"/zyy/icon/2018/"
            }
        '''
        rtn = json.loads(rtnJson)
        return common.buildSuccess(data=rtn)
    ...
    def GetServCmdInfo(self, ticket, taskType, pageInfo, jsonParam):
        ...
        print
        "type:%s, jsonParam:%s" % (type, str(jsonParam))
        rtnJson = '''
            {
                "pageInfo":{
                        "pageNum":1,
...
if __name__ == '__main__':
    ...
    print
    json.dumps(json.loads('{"status":"NORMAL"}'))
    pass
