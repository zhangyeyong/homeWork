...
# 检查机器是否初始化完成   下发"ready to scan"   返回 "initializd finished"
# 扫描成功  下发"scan ok"   返回 "finished"
# 退件   下发"scan NG"   返回 "ready to open door"
serial_command = Storage({
    "SEND_INIT": "ready to scan",
    "SEND_INIT_RECEIVE": "initializd finished",
    "SEND_SCAN_OK": "scan ok",
    "SEND_SCAN_OK_RECEIVE": "finished",
    "SEND_SCAN_NG": "scan NG",
    "SEND_SCAN_NG_RECEIVE": "ready to open door"
})
