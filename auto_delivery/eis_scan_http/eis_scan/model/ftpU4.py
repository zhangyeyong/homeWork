...
#             ret = myftp.upload(remoteHost, remotePort, loginname, loginpassword, remotepath, localpath)
            myftp.upload(remoteHost, remotePort, loginname, loginpassword, remotepath, localpath,callback)
#             remotepath = "a"
...
#             ret = myftp.upload(remoteHost, remotePort, loginname, loginpassword, remotepath, localpath,callback)
#             print t2
#             print "upload--------------->%s/n"%str(ret)
#             print "call uploadTaskDao time :%f" % (t2 - t1)
             
#             myftp.deleteRemoteFile(remoteHost, remotePort, loginname, loginpassword, remotepath)
 
#             localpath = "D:/temp/image/download/%d.jpg" % (i + 1)
#             remotepath = "zyy/new/1%d.jpg" % (i + 1)
#             ret = myftp.download(remoteHost, remotePort, loginname, loginpassword, remotepath, localpath)
#             print "download--------------->%s\n" % str(ret)
    except Exception, e:
        traceback.print_exc()
