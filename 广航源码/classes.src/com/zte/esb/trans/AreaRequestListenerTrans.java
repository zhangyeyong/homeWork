...
public class AreaRequestListenerTrans
{
  private static Log log = LogFactory.getLog(AreaRequestListenerTrans.class);
  private static final Class<SyncDistrictRequest> clzz = SyncDistrictRequest.class;
  private static JAXBContext context = initContext();
  
  public static SyncDistrictRequest toMessage(String paramString)
    throws Exception
  {
    try
    {
      ...
      return (SyncDistrictRequest)localJAXBElement.getValue();
    }
  ...
  public static String fromMessage(SyncDistrictRequest paramSyncDistrictRequest)
    throws Exception
  {
    if (paramSyncDistrictRequest == null) {
      return null;
    }
    try
    {
      ...
      JAXBElement localJAXBElement = new ObjectFactory().createSyncDistrictRequest(paramSyncDistrictRequest);
    ...
    {
      throw new Exception("序列化" + paramSyncDistrictRequest.getClass().getName() + "时失败！", localPropertyException);
    }
    catch (FactoryConfigurationError localFactoryConfigurationError)
    {
      throw new Exception("序列化" + paramSyncDistrictRequest.getClass().getName() + "时失败！", localFactoryConfigurationError);
    }
    catch (JAXBException localJAXBException)
    {
      throw new Exception("序列化" + paramSyncDistrictRequest.getClass().getName() + "时失败！", localJAXBException);
    }
  }
 ...
 * Qualified Name:     com.zte.esb.trans.AreaRequestListenerTrans
