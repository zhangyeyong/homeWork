...
public class EisGetResponseTrans
{
  private static Log log = LogFactory.getLog(EisGetResponse.class);
  private static final Class<EisGetResponse> clzz = EisGetResponse.class;
  private static JAXBContext context = initContext();
  
  public static EisGetResponse toMessage(String paramString)
    throws Exception
  {
    try
    {
      ...
      return (EisGetResponse)localJAXBElement.getValue();
    }
  ...
  public static String fromMessage(EisGetResponse paramEisGetResponse)
    throws Exception
  {
    if (paramEisGetResponse == null) {
      return null;
    }
    try
    {
      ...
      JAXBElement localJAXBElement = new ObjectFactory().createEisGetResponse(paramEisGetResponse);
    ...
    {
      throw new Exception("序列化" + paramEisGetResponse.getClass().getName() + "时失败！", localPropertyException);
    }
    catch (FactoryConfigurationError localFactoryConfigurationError)
    {
      throw new Exception("序列化" + paramEisGetResponse.getClass().getName() + "时失败！", localFactoryConfigurationError);
    }
    catch (JAXBException localJAXBException)
    {
      throw new Exception("序列化" + paramEisGetResponse.getClass().getName() + "时失败！", localJAXBException);
    }
  }
 ...
 * Qualified Name:     com.zte.esb.trans.EisGetResponseTrans
