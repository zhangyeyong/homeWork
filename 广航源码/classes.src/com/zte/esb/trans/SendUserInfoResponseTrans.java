...
public class SendUserInfoResponseTrans
{
  private static Log log = LogFactory.getLog(SendUserInfoResponse.class);
  private static final Class<SendUserInfoResponse> clzz = SendUserInfoResponse.class;
  private static JAXBContext context = initContext();
  
  public static SendUserInfoResponse toMessage(String paramString)
    throws Exception
  {
    try
    {
      ...
      return (SendUserInfoResponse)localJAXBElement.getValue();
    }
  ...
  public static String fromMessage(SendUserInfoResponse paramSendUserInfoResponse)
    throws Exception
  {
    if (paramSendUserInfoResponse == null) {
      return null;
    }
    try
    {
      ...
      JAXBElement localJAXBElement = new ObjectFactory().createSendUserInfoResponse(paramSendUserInfoResponse);
    ...
    {
      throw new Exception("序列化" + paramSendUserInfoResponse.getClass().getName() + "时失败！", localPropertyException);
    }
    catch (FactoryConfigurationError localFactoryConfigurationError)
    {
      throw new Exception("序列化" + paramSendUserInfoResponse.getClass().getName() + "时失败！", localFactoryConfigurationError);
    }
    catch (JAXBException localJAXBException)
    {
      throw new Exception("序列化" + paramSendUserInfoResponse.getClass().getName() + "时失败！", localJAXBException);
    }
  }
 ...
 * Qualified Name:     com.zte.esb.trans.SendUserInfoResponseTrans
