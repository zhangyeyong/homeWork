...
public class SendEmployeeResponseTrans
{
  private static Log log = LogFactory.getLog(SendEmployeeResponse.class);
  private static final Class<SendEmployeeResponse> clzz = SendEmployeeResponse.class;
  private static JAXBContext context = initContext();
  
  public static SendEmployeeResponse toMessage(String paramString)
    throws Exception
  {
    try
    {
      ...
      return (SendEmployeeResponse)localJAXBElement.getValue();
    }
  ...
  public static String fromMessage(SendEmployeeResponse paramSendEmployeeResponse)
    throws Exception
  {
    if (paramSendEmployeeResponse == null) {
      return null;
    }
    try
    {
      ...
      JAXBElement localJAXBElement = new ObjectFactory().createSendEmployeeResponse(paramSendEmployeeResponse);
    ...
    {
      throw new Exception("序列化" + paramSendEmployeeResponse.getClass().getName() + "时失败！", localPropertyException);
    }
    catch (FactoryConfigurationError localFactoryConfigurationError)
    {
      throw new Exception("序列化" + paramSendEmployeeResponse.getClass().getName() + "时失败！", localFactoryConfigurationError);
    }
    catch (JAXBException localJAXBException)
    {
      throw new Exception("序列化" + paramSendEmployeeResponse.getClass().getName() + "时失败！", localJAXBException);
    }
  }
 ...
 * Qualified Name:     com.zte.esb.trans.SendEmployeeResponseTrans
