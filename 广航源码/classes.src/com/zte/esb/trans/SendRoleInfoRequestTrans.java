...
public class SendRoleInfoRequestTrans
{
  private static Log log = LogFactory.getLog(SendRoleInfoRequest.class);
  private static final Class<SendRoleInfoRequest> clzz = SendRoleInfoRequest.class;
  private static JAXBContext context = initContext();
  
  public static SendRoleInfoRequest toMessage(String paramString)
    throws Exception
  {
    try
    {
      ...
      return (SendRoleInfoRequest)localJAXBElement.getValue();
    }
  ...
  public static String fromMessage(SendRoleInfoRequest paramSendRoleInfoRequest)
    throws Exception
  {
    if (paramSendRoleInfoRequest == null) {
      return null;
    }
    try
    {
      ...
      JAXBElement localJAXBElement = new ObjectFactory().createSendRoleInfoRequest(paramSendRoleInfoRequest);
    ...
    {
      throw new Exception("序列化" + paramSendRoleInfoRequest.getClass().getName() + "时失败！", localPropertyException);
    }
    catch (FactoryConfigurationError localFactoryConfigurationError)
    {
      throw new Exception("序列化" + paramSendRoleInfoRequest.getClass().getName() + "时失败！", localFactoryConfigurationError);
    }
    catch (JAXBException localJAXBException)
    {
      throw new Exception("序列化" + paramSendRoleInfoRequest.getClass().getName() + "时失败！", localJAXBException);
    }
  }
 ...
 * Qualified Name:     com.zte.esb.trans.SendRoleInfoRequestTrans
