...
public class SendUserInfoRequestTrans
{
  private static Log log = LogFactory.getLog(SendUserInfoRequest.class);
  private static final Class<SendUserInfoRequest> clzz = SendUserInfoRequest.class;
  private static JAXBContext context = initContext();
  
  public static SendUserInfoRequest toMessage(String paramString)
    throws Exception
  {
    try
    {
      ...
      return (SendUserInfoRequest)localJAXBElement.getValue();
    }
  ...
  public static String fromMessage(SendUserInfoRequest paramSendUserInfoRequest)
    throws Exception
  {
    ...
    try
    {
      ...
      JAXBElement localJAXBElement = new ObjectFactory().createSendUserInfoRequest(paramSendUserInfoRequest);
    ...
    {
      throw new Exception("序列化" + paramSendUserInfoRequest.getClass().getName() + "时失败！", localPropertyException);
    }
    catch (FactoryConfigurationError localFactoryConfigurationError)
    {
      throw new Exception("序列化" + paramSendUserInfoRequest.getClass().getName() + "时失败！", localFactoryConfigurationError);
    }
    catch (JAXBException localJAXBException)
    {
      throw new Exception("序列化" + paramSendUserInfoRequest.getClass().getName() + "时失败！", localJAXBException);
    }
  }
 ...
 * Qualified Name:     com.zte.esb.trans.SendUserInfoRequestTrans
