...
public class EisEvaluationRequestTrans
{
  private static Log log = LogFactory.getLog(SendDegreeRequest.class);
  private static final Class<EisEvaluationRequest> clzz = EisEvaluationRequest.class;
  private static JAXBContext context = initContext();
  
  public static EisEvaluationRequest toMessage(String paramString)
    throws Exception
  {
    try
    {
      ...
      return (EisEvaluationRequest)localJAXBElement.getValue();
    }
  ...
  public static String fromMessage(EisEvaluationRequest paramEisEvaluationRequest)
    throws Exception
  {
    if (paramEisEvaluationRequest == null) {
      return null;
    }
    try
    {
      ...
      JAXBElement localJAXBElement = new ObjectFactory().createEisEvaluationRequest(paramEisEvaluationRequest);
    ...
    {
      throw new Exception("序列化" + paramEisEvaluationRequest.getClass().getName() + "时失败！", localPropertyException);
    }
    catch (FactoryConfigurationError localFactoryConfigurationError)
    {
      throw new Exception("序列化" + paramEisEvaluationRequest.getClass().getName() + "时失败！", localFactoryConfigurationError);
    }
    catch (JAXBException localJAXBException)
    {
      throw new Exception("序列化" + paramEisEvaluationRequest.getClass().getName() + "时失败！", localJAXBException);
    }
  }
 ...
 * Qualified Name:     com.zte.esb.trans.EisEvaluationRequestTrans
