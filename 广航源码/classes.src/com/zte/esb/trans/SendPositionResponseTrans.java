...
public class SendPositionResponseTrans
{
  private static Log log = LogFactory.getLog(SendPositionResponse.class);
  private static final Class<SendPositionResponse> clzz = SendPositionResponse.class;
  private static JAXBContext context = initContext();
  
  public static SendPositionResponse toMessage(String paramString)
    throws Exception
  {
    try
    {
      ...
      return (SendPositionResponse)localJAXBElement.getValue();
    }
  ...
  public static String fromMessage(SendPositionResponse paramSendPositionResponse)
    throws Exception
  {
    if (paramSendPositionResponse == null) {
      return null;
    }
    try
    {
      ...
      JAXBElement localJAXBElement = new ObjectFactory().createSendPositionResponse(paramSendPositionResponse);
    ...
    {
      throw new Exception("序列化" + paramSendPositionResponse.getClass().getName() + "时失败！", localPropertyException);
    }
    catch (FactoryConfigurationError localFactoryConfigurationError)
    {
      throw new Exception("序列化" + paramSendPositionResponse.getClass().getName() + "时失败！", localFactoryConfigurationError);
    }
    catch (JAXBException localJAXBException)
    {
      throw new Exception("序列化" + paramSendPositionResponse.getClass().getName() + "时失败！", localJAXBException);
    }
  }
 ...
 * Qualified Name:     com.zte.esb.trans.SendPositionResponseTrans
