...
@XmlType(name="specialAttachmentResponse", propOrder={"claimBillNumber", "successMark", "failtureReason"})
@XmlRootElement
public class SpecialAttachmentResponse
{
  ...
  {
    return "SpecialAttachmentResponse [claimBillNumber=" + this.claimBillNumber + ", successMark=" + this.successMark + ", failtureReason=" + this.failtureReason + "]";
  }
}


/* Location:           C:\Users\zhangyeyong\Downloads\gdc_evs\evs\webapps\evs\WEB-INF\classes\
 * Qualified Name:     com.zte.esb.bean.fssc.SpecialAttachmentResponse
