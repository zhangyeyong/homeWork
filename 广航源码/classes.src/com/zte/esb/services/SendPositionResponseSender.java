...
import com.zte.esb.trans.SendPositionResponseTrans;
...
public class SendPositionResponseSender
{
  private static Log log = LogFactory.getLog(SendPositionResponseSender.class);
        ...
        throws JMSException
      {
        ...
        try
        {
          ...
          if (paramBoolean)
          {
            ...
            localObject = (SendPositionResponse)paramObject;
            str = SendPositionResponseTrans.fromMessage((SendPositionResponse)localObject);
          }
          else
          {
          ...
          SendPositionResponseSender.log.info("返回的报文:" + str);
        ...
        {
          SendPositionResponseSender.log.info("转化错误");
 ...
 * Qualified Name:     com.zte.esb.services.SendPositionResponseSender
