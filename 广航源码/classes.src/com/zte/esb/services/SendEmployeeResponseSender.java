...
public class SendEmployeeResponseSender
{
  private static Log log = LogFactory.getLog(SendEmployeeResponseSender.class);
        ...
        throws JMSException
      {
        ...
        try
        {
          ...
          if (paramBoolean)
          {
            ...
            localObject = (SendEmployeeResponse)paramObject;
          ...
          SendEmployeeResponseSender.log.info("返回的报文:" + str);
        ...
        {
          SendEmployeeResponseSender.log.info("转化错误");
 ...
 * Qualified Name:     com.zte.esb.services.SendEmployeeResponseSender
