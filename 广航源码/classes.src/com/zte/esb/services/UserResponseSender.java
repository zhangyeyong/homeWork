...
import com.zte.esb.trans.SendUserInfoResponseTrans;
        ...
        throws JMSException
      {
        ...
        try
        {
          ...
          if (paramBoolean)
          {
            ...
            localObject = (SendUserInfoResponse)paramObject;
            str = SendUserInfoResponseTrans.fromMessage((SendUserInfoResponse)localObject);
          }
          else
          {
          ...
          UserResponseSender.log.info("返回的报文:" + str);
        ...
        {
          UserResponseSender.log.info("转化错误");
 ...
 * Qualified Name:     com.zte.esb.services.UserResponseSender
