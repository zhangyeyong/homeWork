  ...
  public static void setWho(Object paramObject)
  {
    ...
    try
    {
      ...
      for (int i = 0; i < arrayOfMethod.length; i++)
      {
        ...
        else if (((String)localObject2).equals("getLastUpdateBy"))
        {
          localObject1 = arrayOfMethod[i].invoke(paramObject, new Object[0]);
          localHashMap1.put("getLastUpdateBy", localObject1);
        }
        ...
        else if (((String)localObject2).equals("setLastUpdateBy"))
        {
          localHashMap2.put("getLastUpdateBy", arrayOfMethod[i]);
        }
      ...
      ISession localISession = ((RIAContext)localObject2).getSession();
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        Object localObject3 = localHashMap1.get(str);
        Method localMethod;
        if (str.equals("getCreatedBy"))
        {
          if (localObject3 == null)
          {
            localMethod = (Method)localHashMap2.get(str);
            localMethod.invoke(paramObject, new Object[] { localLong });
          }
        }
        else if (str.equals("getCreationDate"))
        {
          ...
          {
            localMethod = (Method)localHashMap2.get(str);
            localMethod.invoke(paramObject, new Object[] { new Date() });
          }
        }
        else if (str.equals("getLastUpdateDate"))
        {
          localMethod = (Method)localHashMap2.get(str);
          localMethod.invoke(paramObject, new Object[] { new Date() });
        }
        else if (str.equals("getLastUpdatedBy"))
        {
          localMethod = (Method)localHashMap2.get(str);
          localMethod.invoke(paramObject, new Object[] { localLong });
        }
        else if (str.equals("getLastUpdateBy"))
        {
          localMethod = (Method)localHashMap2.get(str);
          localMethod.invoke(paramObject, new Object[] { localLong });
        }
        else if (str.equals("getLastUpdateLogin"))
        {
          localMethod = (Method)localHashMap2.get(str);
          localMethod.invoke(paramObject, new Object[] { localLong });
        }
 ...
 * Qualified Name:     com.zte.evs.ebill.common.ObjectCopyUtils
