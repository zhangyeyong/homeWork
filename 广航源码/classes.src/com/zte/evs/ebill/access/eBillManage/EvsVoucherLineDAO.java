...
public class EvsVoucherLineDAO
  extends BaseDAO
  implements IEvsVoucherLineDAO
{
  public List<EvsVoucherLine> findLineByVoucherId(Long paramLong, String paramString)
  {
    return getSession().createQuery("from EvsVoucherLine l where l.voucherId=" + paramLong).list();
  }
 ...
 * Qualified Name:     com.zte.evs.ebill.access.eBillManage.EvsVoucherLineDAO
