...
{
  private String createImageSrv_address = AccessPropertiesFile.getValue("createImageSrv_address");
  ...
  {
    return new QName("http://127.0.0.1/evs_haier", "CreateImageSrvService");
  }
  ...
  public Iterator getPorts()
  {
    if (this.ports == null)
    {
      ...
      this.ports.add(new QName("http://127.0.0.1/evs_haier", "createImageSrv"));
    }
 ...
 * Qualified Name:     com.zte.web.service.client.createImage.client.CreateImageSrvServiceLocator
