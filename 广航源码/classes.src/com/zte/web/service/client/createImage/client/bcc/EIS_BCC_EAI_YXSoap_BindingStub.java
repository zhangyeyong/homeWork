...
public class EIS_BCC_EAI_YXSoap_BindingStub
  extends Stub
  implements EIS_BCC_EAI_YXSoap_PortType
{
  ...
  private static void _initOperationDesc1()
  {
    ...
    ParameterDesc localParameterDesc = new ParameterDesc(new QName("http://tempuri.org/", "sMod"), (byte)1, new QName("http://tempuri.org/", "modEIS"), ModEIS.class, false, false);
    ...
    localOperationDesc.setReturnQName(new QName("http://tempuri.org/", "CreateImageResult"));
    localOperationDesc.setStyle(Style.WRAPPED);
    localOperationDesc.setUse(Use.LITERAL);
    _operations[0] = localOperationDesc;
  }
  
  public EIS_BCC_EAI_YXSoap_BindingStub()
    throws AxisFault
  {
    this(null);
  }
  
  public EIS_BCC_EAI_YXSoap_BindingStub(URL paramURL, javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    this(paramService);
  ...
  public EIS_BCC_EAI_YXSoap_BindingStub(javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    ...
    QName localQName = new QName("http://tempuri.org/", "modEIS");
    this.cachedSerQNames.add(localQName);
    ModEIS localModEIS = ModEIS.class;
    this.cachedSerClasses.add(localModEIS);
  ...
  /* Error */
  public String createImage(ModEIS paramModEIS)
    throws RemoteException
  {
    // Byte code:
    //   0: aload_0
    ...
    //   14: athrow
    //   15: aload_0
    //   16: invokevirtual 87	com/zte/web/service/client/createImage/client/bcc/EIS_BCC_EAI_YXSoap_BindingStub:createCall	()Lorg/apache/axis/client/Call;
    //   19: astore_2
    //   20: aload_2
    //   21: getstatic 26	com/zte/web/service/client/createImage/client/bcc/EIS_BCC_EAI_YXSoap_BindingStub:_operations	[Lorg/apache/axis/description/OperationDesc;
    //   24: iconst_0
    //   25: aaload
    ...
    //   85: aload_0
    //   86: aload_2
    //   87: invokevirtual 98	com/zte/web/service/client/createImage/client/bcc/EIS_BCC_EAI_YXSoap_BindingStub:setRequestHeaders	(Lorg/apache/axis/client/Call;)V
    //   90: aload_0
    //   91: aload_2
    //   92: invokevirtual 99	com/zte/web/service/client/createImage/client/bcc/EIS_BCC_EAI_YXSoap_BindingStub:setAttachments	(Lorg/apache/axis/client/Call;)V
    //   95: aload_2
    //   96: iconst_1
    ...
    //   120: aload_0
    //   121: aload_2
    //   122: invokevirtual 103	com/zte/web/service/client/createImage/client/bcc/EIS_BCC_EAI_YXSoap_BindingStub:extractAttachments	(Lorg/apache/axis/client/Call;)V
    //   125: aload_3
    //   126: checkcast 18	java/lang/String
    //   129: areturn
    //   130: astore 4
    //   132: aload_3
    //   133: ldc_w 18
    //   136: invokestatic 105	org/apache/axis/utils/JavaUtils:convert	(Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;
    //   139: checkcast 18	java/lang/String
    //   142: areturn
    //   143: astore_3
    //   144: aload_3
    //   145: athrow
    ...
    //   0	146	0	this	EIS_BCC_EAI_YXSoap_BindingStub
    //   0	146	1	paramModEIS	ModEIS
 ...
 * Qualified Name:     com.zte.web.service.client.createImage.client.bcc.EIS_BCC_EAI_YXSoap_BindingStub
