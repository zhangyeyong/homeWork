  ...
  implements Serializable
{
  ...
  static
  {
    typeDesc.setXmlType(new QName("http://127.0.0.1/evs_haier", "CreateImageRequest"));
    ElementDesc localElementDesc = new ElementDesc();
    localElementDesc.setFieldName("imageList");
    localElementDesc.setXmlName(new QName("http://127.0.0.1/evs_haier", "imageList"));
    localElementDesc.setXmlType(new QName("http://127.0.0.1/evs_haier", "ImageList"));
    localElementDesc.setNillable(true);
    localElementDesc.setItemQName(new QName("http://127.0.0.1/evs_haier", "item"));
 ...
 * Qualified Name:     com.zte.web.service.client.createImage.client.CreateImageRequest
