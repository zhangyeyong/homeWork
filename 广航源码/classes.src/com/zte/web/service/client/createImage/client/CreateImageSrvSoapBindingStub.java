...
public class CreateImageSrvSoapBindingStub
  extends Stub
  implements CreateImageSrv
{
  ...
  private static void _initOperationDesc1()
  {
    ...
    ParameterDesc localParameterDesc = new ParameterDesc(new QName("http://127.0.0.1/evs_haier", "request"), (byte)1, new QName("http://127.0.0.1/evs_haier", "CreateImageRequest"), CreateImageRequest.class, false, false);
    ...
    localOperationDesc.setReturnQName(new QName("http://127.0.0.1/evs_haier", "createImageReturn"));
    ...
    localParameterDesc = new ParameterDesc(new QName("http://127.0.0.1/evs_haier", "req"), (byte)1, new QName("http://127.0.0.1/evs_haier", "CreateImageRequest"), CreateImageRequest.class, false, false);
    localOperationDesc.addParameter(localParameterDesc);
    localOperationDesc.setReturnType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
    localOperationDesc.setReturnClass(String.class);
    localOperationDesc.setReturnQName(new QName("http://127.0.0.1/evs_haier", "deleteImageReturn"));
    localOperationDesc.setStyle(Style.DOCUMENT);
    localOperationDesc.setUse(Use.LITERAL);
    _operations[1] = localOperationDesc;
  }
  
  public CreateImageSrvSoapBindingStub()
    throws AxisFault
  {
    this(null);
  }
  
  public CreateImageSrvSoapBindingStub(URL paramURL, javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    this(paramService);
  ...
  public CreateImageSrvSoapBindingStub(javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    ...
    QName localQName1 = new QName("http://127.0.0.1/evs_haier", "ArrayOfImageList");
    this.cachedSerQNames.add(localQName1);
    Object localObject = [Lcom.zte.web.service.client.createImage.client.ImageList.class;
    this.cachedSerClasses.add(localObject);
    localQName1 = new QName("http://127.0.0.1/evs_haier", "ImageList");
    QName localQName2 = new QName("http://127.0.0.1/evs_haier", "item");
    this.cachedSerFactories.add(new ArraySerializerFactory(localQName1, localQName2));
    this.cachedDeserFactories.add(new ArrayDeserializerFactory());
    localQName1 = new QName("http://127.0.0.1/evs_haier", "CreateImageRequest");
    this.cachedSerQNames.add(localQName1);
    localObject = CreateImageRequest.class;
    this.cachedSerClasses.add(localObject);
    this.cachedSerFactories.add(localBeanSerializerFactory);
    this.cachedDeserFactories.add(localBeanDeserializerFactory);
    localQName1 = new QName("http://127.0.0.1/evs_haier", "ImageList");
    this.cachedSerQNames.add(localQName1);
    localObject = ImageList.class;
    this.cachedSerClasses.add(localObject);
    this.cachedSerFactories.add(localBeanSerializerFactory);
    this.cachedDeserFactories.add(localBeanDeserializerFactory);
  }
  ...
  /* Error */
  public String createImage(CreateImageRequest paramCreateImageRequest)
    throws RemoteException
  {
    // Byte code:
    //   0: aload_0
    ...
    //   14: athrow
    //   15: aload_0
    //   16: invokevirtual 96	com/zte/web/service/client/createImage/client/CreateImageSrvSoapBindingStub:createCall	()Lorg/apache/axis/client/Call;
    //   19: astore_2
    //   20: aload_2
    //   21: getstatic 25	com/zte/web/service/client/createImage/client/CreateImageSrvSoapBindingStub:_operations	[Lorg/apache/axis/description/OperationDesc;
    //   24: iconst_0
    //   25: aaload
    ...
    //   34: aload_2
    //   35: ldc 99
    //   37: invokevirtual 100	org/apache/axis/client/Call:setSOAPActionURI	(Ljava/lang/String;)V
    //   40: aload_2
    //   41: aconst_null
    //   42: invokevirtual 81	org/apache/axis/client/Call:setEncodingStyle	(Ljava/lang/String;)V
    //   45: aload_2
    //   46: ldc 101
    //   48: getstatic 102	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   51: invokevirtual 79	org/apache/axis/client/Call:setProperty	(Ljava/lang/String;Ljava/lang/Object;)V
    //   54: aload_2
    //   55: ldc 103
    //   57: getstatic 102	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   60: invokevirtual 79	org/apache/axis/client/Call:setProperty	(Ljava/lang/String;Ljava/lang/Object;)V
    //   63: aload_2
    //   64: getstatic 104	org/apache/axis/soap/SOAPConstants:SOAP11_CONSTANTS	Lorg/apache/axis/soap/SOAP11Constants;
    //   67: invokevirtual 105	org/apache/axis/client/Call:setSOAPVersion	(Lorg/apache/axis/soap/SOAPConstants;)V
    //   70: aload_2
    ...
    //   82: invokevirtual 106	org/apache/axis/client/Call:setOperationName	(Ljavax/xml/namespace/QName;)V
    //   85: aload_0
    //   86: aload_2
    //   87: invokevirtual 107	com/zte/web/service/client/createImage/client/CreateImageSrvSoapBindingStub:setRequestHeaders	(Lorg/apache/axis/client/Call;)V
    //   90: aload_0
    //   91: aload_2
    //   92: invokevirtual 108	com/zte/web/service/client/createImage/client/CreateImageSrvSoapBindingStub:setAttachments	(Lorg/apache/axis/client/Call;)V
    //   95: aload_2
    //   96: iconst_1
    //   97: anewarray 109	java/lang/Object
    //   100: dup
    //   101: iconst_0
    //   102: aload_1
    //   103: aastore
    //   104: invokevirtual 110	org/apache/axis/client/Call:invoke	([Ljava/lang/Object;)Ljava/lang/Object;
    //   107: astore_3
    //   108: aload_3
    //   109: instanceof 111
    //   112: ifeq +8 -> 120
    //   115: aload_3
    //   116: checkcast 111	java/rmi/RemoteException
    //   119: athrow
    //   120: aload_0
    //   121: aload_2
    //   122: invokevirtual 112	com/zte/web/service/client/createImage/client/CreateImageSrvSoapBindingStub:extractAttachments	(Lorg/apache/axis/client/Call;)V
    //   125: aload_3
    //   126: checkcast 17	java/lang/String
    //   129: areturn
    //   130: astore 4
    //   132: aload_3
    //   133: ldc_w 17
    //   136: invokestatic 114	org/apache/axis/utils/JavaUtils:convert	(Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;
    //   139: checkcast 17	java/lang/String
    //   142: areturn
    //   143: astore_3
    //   144: aload_3
    //   145: athrow
    ...
    //   0	146	0	this	CreateImageSrvSoapBindingStub
    //   0	146	1	paramCreateImageRequest	CreateImageRequest
  ...
  /* Error */
  public String deleteImage(CreateImageRequest paramCreateImageRequest)
    throws RemoteException
  {
    // Byte code:
    //   0: aload_0
 ...
 * Qualified Name:     com.zte.web.service.client.createImage.client.CreateImageSrvSoapBindingStub
