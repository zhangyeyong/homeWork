...
public class MergeBoeSrvSoapBindingStub
  extends Stub
  implements MergeBoeSrv
{
  ...
  private static void _initOperationDesc1()
  {
    ...
    localOperationDesc.setName("mergeBoeSrv");
    ParameterDesc localParameterDesc = new ParameterDesc(new QName("http://127.0.0.1/deppon", "req"), (byte)1, new QName("impl:MergeBoeRequest", "MergeBoeRequest"), MergeBoeRequest.class, false, false);
    ...
    localOperationDesc.setReturnClass(MergeBoeResponse.class);
    localOperationDesc.setReturnQName(new QName("http://127.0.0.1/deppon", "mergeBoeSrvReturn"));
    localOperationDesc.setStyle(Style.DOCUMENT);
    localOperationDesc.setUse(Use.LITERAL);
    _operations[0] = localOperationDesc;
  }
  
  public MergeBoeSrvSoapBindingStub()
    throws AxisFault
  {
    this(null);
  }
  
  public MergeBoeSrvSoapBindingStub(URL paramURL, javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    this(paramService);
  ...
  public MergeBoeSrvSoapBindingStub(javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    ...
    QName localQName1 = new QName("http://127.0.0.1/deppon", "ArrayOf_xsd_string");
    ...
    QName localQName2 = new QName("http://127.0.0.1/deppon", "item");
    this.cachedSerFactories.add(new ArraySerializerFactory(localQName1, localQName2));
    this.cachedDeserFactories.add(new ArrayDeserializerFactory());
    localQName1 = new QName("impl:MergeBoeRequest", "MergeBoeRequest");
    this.cachedSerQNames.add(localQName1);
    localObject = MergeBoeRequest.class;
    this.cachedSerClasses.add(localObject);
    this.cachedSerFactories.add(localBeanSerializerFactory);
    this.cachedDeserFactories.add(localBeanDeserializerFactory);
    localQName1 = new QName("impl:MergeBoeResponse", "MergeBoeResponse");
    this.cachedSerQNames.add(localQName1);
    localObject = MergeBoeResponse.class;
    this.cachedSerClasses.add(localObject);
    this.cachedSerFactories.add(localBeanSerializerFactory);
    this.cachedDeserFactories.add(localBeanDeserializerFactory);
  }
    ...
    throws RemoteException
  {
    ...
    //   4: ifnonnull +11 -> 15
    //   7: new 93	org/apache/axis/NoEndPointException
    //   10: dup
    //   11: invokespecial 94	org/apache/axis/NoEndPointException:<init>	()V
    //   14: athrow
    //   15: aload_0
    //   16: invokevirtual 95	com/zte/web/service/mergeBoeSrv/service/MergeBoeSrvSoapBindingStub:createCall	()Lorg/apache/axis/client/Call;
    //   19: astore_2
    //   20: aload_2
    //   21: getstatic 26	com/zte/web/service/mergeBoeSrv/service/MergeBoeSrvSoapBindingStub:_operations	[Lorg/apache/axis/description/OperationDesc;
    //   24: iconst_0
    //   25: aaload
    //   26: invokevirtual 96	org/apache/axis/client/Call:setOperation	(Lorg/apache/axis/description/OperationDesc;)V
    //   29: aload_2
    //   30: iconst_1
    //   31: invokevirtual 97	org/apache/axis/client/Call:setUseSOAPAction	(Z)V
    //   34: aload_2
    //   35: ldc 98
    //   37: invokevirtual 99	org/apache/axis/client/Call:setSOAPActionURI	(Ljava/lang/String;)V
    //   40: aload_2
    //   41: aconst_null
    //   42: invokevirtual 80	org/apache/axis/client/Call:setEncodingStyle	(Ljava/lang/String;)V
    //   45: aload_2
    //   46: ldc 100
    //   48: getstatic 101	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   51: invokevirtual 78	org/apache/axis/client/Call:setProperty	(Ljava/lang/String;Ljava/lang/Object;)V
    //   54: aload_2
    //   55: ldc 102
    //   57: getstatic 101	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   60: invokevirtual 78	org/apache/axis/client/Call:setProperty	(Ljava/lang/String;Ljava/lang/Object;)V
    //   63: aload_2
    ...
    //   82: invokevirtual 105	org/apache/axis/client/Call:setOperationName	(Ljavax/xml/namespace/QName;)V
    //   85: aload_0
    //   86: aload_2
    //   87: invokevirtual 106	com/zte/web/service/mergeBoeSrv/service/MergeBoeSrvSoapBindingStub:setRequestHeaders	(Lorg/apache/axis/client/Call;)V
    //   90: aload_0
    //   91: aload_2
    //   92: invokevirtual 107	com/zte/web/service/mergeBoeSrv/service/MergeBoeSrvSoapBindingStub:setAttachments	(Lorg/apache/axis/client/Call;)V
    //   95: aload_2
    //   96: iconst_1
    //   97: anewarray 108	java/lang/Object
    //   100: dup
    //   101: iconst_0
    //   102: aload_1
    //   103: aastore
    //   104: invokevirtual 109	org/apache/axis/client/Call:invoke	([Ljava/lang/Object;)Ljava/lang/Object;
    //   107: astore_3
    //   108: aload_3
    //   109: instanceof 110
    //   112: ifeq +8 -> 120
    //   115: aload_3
    //   116: checkcast 110	java/rmi/RemoteException
    //   119: athrow
    //   120: aload_0
    //   121: aload_2
    //   122: invokevirtual 111	com/zte/web/service/mergeBoeSrv/service/MergeBoeSrvSoapBindingStub:extractAttachments	(Lorg/apache/axis/client/Call;)V
    //   125: aload_3
    //   126: checkcast 18	com/zte/web/service/mergeBoeSrv/service/MergeBoeResponse
    //   129: areturn
    //   130: astore 4
    //   132: aload_3
    //   133: ldc_w 18
    //   136: invokestatic 113	org/apache/axis/utils/JavaUtils:convert	(Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;
    //   139: checkcast 18	com/zte/web/service/mergeBoeSrv/service/MergeBoeResponse
    //   142: areturn
    //   143: astore_3
    //   144: aload_3
    //   145: athrow
    ...
    //   0	146	0	this	MergeBoeSrvSoapBindingStub
    //   0	146	1	paramMergeBoeRequest	MergeBoeRequest
 ...
 * Qualified Name:     com.zte.web.service.mergeBoeSrv.service.MergeBoeSrvSoapBindingStub
