...
public class SendMessageSrvSoapBindingStub
  extends Stub
  implements SendMessageSrv
{
  ...
  private static void _initOperationDesc1()
  {
    ...
    ParameterDesc localParameterDesc = new ParameterDesc(new QName("http://messageSrv.service.web.zte.com", "requestArr"), (byte)1, new QName("http://messageSrv.service.web.zte.com", ">requestArr"), [Lcom.zte.web.service.messageSrv.services.SendMessageSrvRequest.class, false, false);
    localParameterDesc.setItemQName(new QName("http://messageSrv.service.web.zte.com", "item"));
    ...
    localOperationDesc.setReturnClass([Lcom.zte.web.service.messageSrv.services.SendMessageSrvResponse.class);
    localOperationDesc.setReturnQName(new QName("http://eis.haier.com/services/sendMessageSrv", "processReturn"));
    localParameterDesc = localOperationDesc.getReturnParamDesc();
    localParameterDesc.setItemQName(new QName("http://eis.haier.com/services/sendMessageSrv", "item"));
    localOperationDesc.setStyle(Style.DOCUMENT);
    localOperationDesc.setUse(Use.LITERAL);
    _operations[0] = localOperationDesc;
  }
  
  public SendMessageSrvSoapBindingStub()
    throws AxisFault
  {
    this(null);
  }
  
  public SendMessageSrvSoapBindingStub(URL paramURL, javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    this(paramService);
  ...
  public SendMessageSrvSoapBindingStub(javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    ...
    QName localQName1 = new QName("http://eis.haier.com/services/sendMessageSrv", ">processReturn");
    this.cachedSerQNames.add(localQName1);
    Object localObject = [Lcom.zte.web.service.messageSrv.services.SendMessageSrvResponse.class;
    this.cachedSerClasses.add(localObject);
    localQName1 = new QName("impl:SendMessageSrvResponse", "SendMessageSrvResponse");
    QName localQName2 = new QName("http://eis.haier.com/services/sendMessageSrv", "item");
    this.cachedSerFactories.add(new ArraySerializerFactory(localQName1, localQName2));
    this.cachedDeserFactories.add(new ArrayDeserializerFactory());
    localQName1 = new QName("http://messageSrv.service.web.zte.com", ">requestArr");
    this.cachedSerQNames.add(localQName1);
    localObject = [Lcom.zte.web.service.messageSrv.services.SendMessageSrvRequest.class;
    this.cachedSerClasses.add(localObject);
    localQName1 = new QName("impl:SendMessageSrvRequest", "SendMessageSrvRequest");
    localQName2 = new QName("http://messageSrv.service.web.zte.com", "item");
    this.cachedSerFactories.add(new ArraySerializerFactory(localQName1, localQName2));
    this.cachedDeserFactories.add(new ArrayDeserializerFactory());
    localQName1 = new QName("impl:SendMessageSrvRequest", "SendMessageSrvRequest");
    this.cachedSerQNames.add(localQName1);
    localObject = SendMessageSrvRequest.class;
    this.cachedSerClasses.add(localObject);
    this.cachedSerFactories.add(localBeanSerializerFactory);
    this.cachedDeserFactories.add(localBeanDeserializerFactory);
    localQName1 = new QName("impl:SendMessageSrvResponse", "SendMessageSrvResponse");
    this.cachedSerQNames.add(localQName1);
    localObject = SendMessageSrvResponse.class;
    this.cachedSerClasses.add(localObject);
    this.cachedSerFactories.add(localBeanSerializerFactory);
    this.cachedDeserFactories.add(localBeanDeserializerFactory);
  }
    ...
    throws RemoteException
  {
    ...
    //   14: athrow
    //   15: aload_0
    //   16: invokevirtual 98	com/zte/web/service/messageSrv/services/SendMessageSrvSoapBindingStub:createCall	()Lorg/apache/axis/client/Call;
    //   19: astore_2
    //   20: aload_2
    //   21: getstatic 28	com/zte/web/service/messageSrv/services/SendMessageSrvSoapBindingStub:_operations	[Lorg/apache/axis/description/OperationDesc;
    //   24: iconst_0
    //   25: aaload
    ...
    //   85: aload_0
    //   86: aload_2
    //   87: invokevirtual 109	com/zte/web/service/messageSrv/services/SendMessageSrvSoapBindingStub:setRequestHeaders	(Lorg/apache/axis/client/Call;)V
    //   90: aload_0
    //   91: aload_2
    //   92: invokevirtual 110	com/zte/web/service/messageSrv/services/SendMessageSrvSoapBindingStub:setAttachments	(Lorg/apache/axis/client/Call;)V
    //   95: aload_2
    //   96: iconst_1
    ...
    //   120: aload_0
    //   121: aload_2
    //   122: invokevirtual 114	com/zte/web/service/messageSrv/services/SendMessageSrvSoapBindingStub:extractAttachments	(Lorg/apache/axis/client/Call;)V
    //   125: aload_3
    //   126: checkcast 19	[Lcom/zte/web/service/messageSrv/services/SendMessageSrvResponse;
    //   129: checkcast 19	[Lcom/zte/web/service/messageSrv/services/SendMessageSrvResponse;
    //   132: areturn
    //   133: astore 4
    //   135: aload_3
    //   136: ldc_w 19
    //   139: invokestatic 116	org/apache/axis/utils/JavaUtils:convert	(Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;
    //   142: checkcast 19	[Lcom/zte/web/service/messageSrv/services/SendMessageSrvResponse;
    //   145: checkcast 19	[Lcom/zte/web/service/messageSrv/services/SendMessageSrvResponse;
    //   148: areturn
    //   149: astore_3
    //   150: aload_3
    //   151: athrow
    ...
    //   0	152	0	this	SendMessageSrvSoapBindingStub
    //   0	152	1	paramArrayOfSendMessageSrvRequest	SendMessageSrvRequest[]
 ...
 * Qualified Name:     com.zte.web.service.messageSrv.services.SendMessageSrvSoapBindingStub
