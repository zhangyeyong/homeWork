...
public class VideoStatusServiceSoapBinding_registerVideo_RespS_SOAPSerializer
  extends ObjectSerializerBase
  implements Initializable
{
  private static final QName ns1_registerVideoReturn_QNAME = new QName("", "registerVideoReturn");
  ...
  private static final int myregisterVideoReturn_INDEX = 0;
  
  public VideoStatusServiceSoapBinding_registerVideo_RespS_SOAPSerializer(QName paramQName, boolean paramBoolean1, boolean paramBoolean2, SOAPVersion paramSOAPVersion)
  {
  ...
  public Object doDeserialize(SOAPDeserializationState paramSOAPDeserializationState, XMLReader paramXMLReader, SOAPDeserializationContext paramSOAPDeserializationContext)
    throws Exception
  {
    VideoStatusServiceSoapBinding_registerVideo_RespS localVideoStatusServiceSoapBinding_registerVideo_RespS = new VideoStatusServiceSoapBinding_registerVideo_RespS();
    VideoStatusServiceSoapBinding_registerVideo_RespS_SOAPBuilder localVideoStatusServiceSoapBinding_registerVideo_RespS_SOAPBuilder = null;
    int i = 1;
    ...
    if (paramXMLReader.getState() == 1)
    {
      ...
      {
        if (localVideoStatusServiceSoapBinding_registerVideo_RespS_SOAPBuilder == null) {
          localVideoStatusServiceSoapBinding_registerVideo_RespS_SOAPBuilder = new VideoStatusServiceSoapBinding_registerVideo_RespS_SOAPBuilder();
        }
        paramSOAPDeserializationState = registerWithMemberState(localVideoStatusServiceSoapBinding_registerVideo_RespS, paramSOAPDeserializationState, localObject, 0, localVideoStatusServiceSoapBinding_registerVideo_RespS_SOAPBuilder);
        i = 0;
      }
      else if (localObject != null)
      {
        localVideoStatusServiceSoapBinding_registerVideo_RespS.setRegisterVideoReturn(((Boolean)localObject).booleanValue());
      }
      paramXMLReader.nextElementContent();
    }
    ...
    return i != 0 ? localVideoStatusServiceSoapBinding_registerVideo_RespS : paramSOAPDeserializationState;
  }
  ...
  public void doSerializeInstance(Object paramObject, XMLWriter paramXMLWriter, SOAPSerializationContext paramSOAPSerializationContext)
    throws Exception
  {
    VideoStatusServiceSoapBinding_registerVideo_RespS localVideoStatusServiceSoapBinding_registerVideo_RespS = (VideoStatusServiceSoapBinding_registerVideo_RespS)paramObject;
    paramSOAPSerializationContext.setNillable(true);
    this.myns2__boolean__boolean_Boolean_Serializer.serialize(new Boolean(localVideoStatusServiceSoapBinding_registerVideo_RespS.isRegisterVideoReturn()), ns1_registerVideoReturn_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
  }
 ...
 * Qualified Name:     com.zte.eas.eimage.business.video.proxy.runtime.VideoStatusServiceSoapBinding_registerVideo_RespS_SOAPSerializer
