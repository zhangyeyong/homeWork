...
{
  private String EASLogin_address = AccessPropertiesFile.getValue("SSOLogin_address");
  ...
  {
    return new QName("http://192.168.17.194:9888/ormrpc/services/EASLogin", "EASLoginProxyService");
  }
  ...
  public Iterator getPorts()
  {
    if (this.ports == null)
    {
      ...
      this.ports.add(new QName("http://192.168.17.194:9888/ormrpc/services/EASLogin", "EASLogin"));
    }
 ...
 * Qualified Name:     com.zte.eas.login.SSOLogin.EASLoginProxyServiceLocator
