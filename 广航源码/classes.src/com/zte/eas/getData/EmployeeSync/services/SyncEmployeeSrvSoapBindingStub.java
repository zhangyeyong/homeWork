...
public class SyncEmployeeSrvSoapBindingStub
  extends Stub
  implements SyncEmployeeSrv
{
  ...
  private static void _initOperationDesc1()
  {
    ...
    localOperationDesc.setName("syncEmployees");
    ParameterDesc localParameterDesc = new ParameterDesc(new QName("http://validator.EmployeeSync.getData.eas.zte.com", "employees"), (byte)1, new QName("http://validator.EmployeeSync.getData.eas.zte.com", ">employees"), [Lcom.zte.eas.getData.EmployeeSync.services.Employees.class, false, false);
    localParameterDesc.setItemQName(new QName("http://validator.EmployeeSync.getData.eas.zte.com", "item"));
    ...
    localOperationDesc.setReturnClass([Lcom.zte.eas.getData.EmployeeSync.services.Message.class);
    localOperationDesc.setReturnQName(new QName("http://www.evs.com/services/syncEmployeeSrv", "syncEmployeesReturn"));
    localParameterDesc = localOperationDesc.getReturnParamDesc();
    localParameterDesc.setItemQName(new QName("http://www.evs.com/services/syncEmployeeSrv", "item"));
    localOperationDesc.setStyle(Style.DOCUMENT);
    localOperationDesc.setUse(Use.LITERAL);
    _operations[0] = localOperationDesc;
  }
  
  public SyncEmployeeSrvSoapBindingStub()
    throws AxisFault
  {
    this(null);
  }
  
  public SyncEmployeeSrvSoapBindingStub(URL paramURL, javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    this(paramService);
  ...
  public SyncEmployeeSrvSoapBindingStub(javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    ...
    QName localQName1 = new QName("http://validator.EmployeeSync.getData.eas.zte.com", ">employees");
    this.cachedSerQNames.add(localQName1);
    Object localObject = [Lcom.zte.eas.getData.EmployeeSync.services.Employees.class;
    this.cachedSerClasses.add(localObject);
    localQName1 = new QName("impl:Employees", "Employees");
    QName localQName2 = new QName("http://validator.EmployeeSync.getData.eas.zte.com", "item");
    this.cachedSerFactories.add(new ArraySerializerFactory(localQName1, localQName2));
    this.cachedDeserFactories.add(new ArrayDeserializerFactory());
    localQName1 = new QName("http://www.evs.com/services/syncEmployeeSrv", ">syncEmployeesReturn");
    this.cachedSerQNames.add(localQName1);
    localObject = [Lcom.zte.eas.getData.EmployeeSync.services.Message.class;
    this.cachedSerClasses.add(localObject);
    localQName1 = new QName("impl:Message", "Message");
    localQName2 = new QName("http://www.evs.com/services/syncEmployeeSrv", "item");
    this.cachedSerFactories.add(new ArraySerializerFactory(localQName1, localQName2));
    this.cachedDeserFactories.add(new ArrayDeserializerFactory());
    localQName1 = new QName("impl:Employees", "Employees");
    this.cachedSerQNames.add(localQName1);
    localObject = Employees.class;
    this.cachedSerClasses.add(localObject);
    ...
    throws RemoteException
  {
    ...
    //   14: athrow
    //   15: aload_0
    //   16: invokevirtual 98	com/zte/eas/getData/EmployeeSync/services/SyncEmployeeSrvSoapBindingStub:createCall	()Lorg/apache/axis/client/Call;
    //   19: astore_2
    //   20: aload_2
    //   21: getstatic 28	com/zte/eas/getData/EmployeeSync/services/SyncEmployeeSrvSoapBindingStub:_operations	[Lorg/apache/axis/description/OperationDesc;
    //   24: iconst_0
    //   25: aaload
    ...
    //   85: aload_0
    //   86: aload_2
    //   87: invokevirtual 109	com/zte/eas/getData/EmployeeSync/services/SyncEmployeeSrvSoapBindingStub:setRequestHeaders	(Lorg/apache/axis/client/Call;)V
    //   90: aload_0
    //   91: aload_2
    //   92: invokevirtual 110	com/zte/eas/getData/EmployeeSync/services/SyncEmployeeSrvSoapBindingStub:setAttachments	(Lorg/apache/axis/client/Call;)V
    //   95: aload_2
    //   96: iconst_1
    ...
    //   120: aload_0
    //   121: aload_2
    //   122: invokevirtual 114	com/zte/eas/getData/EmployeeSync/services/SyncEmployeeSrvSoapBindingStub:extractAttachments	(Lorg/apache/axis/client/Call;)V
    //   125: aload_3
    //   126: checkcast 19	[Lcom/zte/eas/getData/EmployeeSync/services/Message;
    //   129: checkcast 19	[Lcom/zte/eas/getData/EmployeeSync/services/Message;
    //   132: areturn
    //   133: astore 4
    //   135: aload_3
    //   136: ldc_w 19
    //   139: invokestatic 116	org/apache/axis/utils/JavaUtils:convert	(Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;
    //   142: checkcast 19	[Lcom/zte/eas/getData/EmployeeSync/services/Message;
    //   145: checkcast 19	[Lcom/zte/eas/getData/EmployeeSync/services/Message;
    //   148: areturn
    //   149: astore_3
    //   150: aload_3
    //   151: athrow
    ...
    //   0	152	0	this	SyncEmployeeSrvSoapBindingStub
    //   0	152	1	paramArrayOfEmployees	Employees[]
 ...
 * Qualified Name:     com.zte.eas.getData.EmployeeSync.services.SyncEmployeeSrvSoapBindingStub
