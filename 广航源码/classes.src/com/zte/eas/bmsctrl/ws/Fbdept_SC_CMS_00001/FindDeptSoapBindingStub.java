...
public class FindDeptSoapBindingStub
  extends Stub
  implements FbpDeptsVlDS
{
  ...
  private static void _initOperationDesc1()
  {
    ...
    localOperationDesc.setName("findFbpDeptsVl");
    ...
    localOperationDesc.addParameter(localParameterDesc);
    localOperationDesc.setReturnType(new QName("http://localhost:8080/JSYDEAS/services/findDept", "ArrayOf_tns1_FbpDeptsVll"));
    localOperationDesc.setReturnClass([Lcom.zte.eas.bmsctrl.ws.Fbdept_SC_CMS_00001.FbpDeptsVll.class);
    localOperationDesc.setReturnQName(new QName("", "findFbpDeptsVlReturn"));
    localOperationDesc.setStyle(Style.RPC);
    localOperationDesc.setUse(Use.ENCODED);
    _operations[0] = localOperationDesc;
  }
  
  public FindDeptSoapBindingStub()
    throws AxisFault
  {
    this(null);
  }
  
  public FindDeptSoapBindingStub(URL paramURL, javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    this(paramService);
  ...
  public FindDeptSoapBindingStub(javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    ...
    QName localQName1 = new QName("http://localhost:8080/JSYDEAS/services/findDept", "ArrayOf_tns1_FbpDeptsVll");
    this.cachedSerQNames.add(localQName1);
    Object localObject = [Lcom.zte.eas.bmsctrl.ws.Fbdept_SC_CMS_00001.FbpDeptsVll.class;
    this.cachedSerClasses.add(localObject);
    localQName1 = new QName("urn:BeanService", "FbpDeptsVll");
    QName localQName2 = null;
    this.cachedSerFactories.add(new ArraySerializerFactory(localQName1, localQName2));
    this.cachedDeserFactories.add(new ArrayDeserializerFactory());
    localQName1 = new QName("urn:BeanService", "FbpDeptsVll");
    this.cachedSerQNames.add(localQName1);
    localObject = FbpDeptsVll.class;
    this.cachedSerClasses.add(localObject);
  ...
  /* Error */
  public FbpDeptsVll[] findFbpDeptsVl(String paramString1, String paramString2)
    throws RemoteException
  {
    // Byte code:
    //   0: aload_0
    ...
    //   14: athrow
    //   15: aload_0
    //   16: invokevirtual 96	com/zte/eas/bmsctrl/ws/Fbdept_SC_CMS_00001/FindDeptSoapBindingStub:createCall	()Lorg/apache/axis/client/Call;
    //   19: astore_3
    //   20: aload_3
    //   21: getstatic 27	com/zte/eas/bmsctrl/ws/Fbdept_SC_CMS_00001/FindDeptSoapBindingStub:_operations	[Lorg/apache/axis/description/OperationDesc;
    //   24: iconst_0
    //   25: aaload
    ...
    //   62: aload_0
    //   63: aload_3
    //   64: invokevirtual 102	com/zte/eas/bmsctrl/ws/Fbdept_SC_CMS_00001/FindDeptSoapBindingStub:setRequestHeaders	(Lorg/apache/axis/client/Call;)V
    //   67: aload_0
    //   68: aload_3
    //   69: invokevirtual 103	com/zte/eas/bmsctrl/ws/Fbdept_SC_CMS_00001/FindDeptSoapBindingStub:setAttachments	(Lorg/apache/axis/client/Call;)V
    //   72: aload_3
    //   73: iconst_2
    ...
    //   104: aload_0
    //   105: aload_3
    //   106: invokevirtual 107	com/zte/eas/bmsctrl/ws/Fbdept_SC_CMS_00001/FindDeptSoapBindingStub:extractAttachments	(Lorg/apache/axis/client/Call;)V
    //   109: aload 4
    //   111: checkcast 19	[Lcom/zte/eas/bmsctrl/ws/Fbdept_SC_CMS_00001/FbpDeptsVll;
    //   114: checkcast 19	[Lcom/zte/eas/bmsctrl/ws/Fbdept_SC_CMS_00001/FbpDeptsVll;
    //   117: areturn
    //   118: astore 5
    //   120: aload 4
    //   122: ldc_w 19
    //   125: invokestatic 109	org/apache/axis/utils/JavaUtils:convert	(Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;
    //   128: checkcast 19	[Lcom/zte/eas/bmsctrl/ws/Fbdept_SC_CMS_00001/FbpDeptsVll;
    //   131: checkcast 19	[Lcom/zte/eas/bmsctrl/ws/Fbdept_SC_CMS_00001/FbpDeptsVll;
    //   134: areturn
    //   135: astore 4
    //   137: aload 4
    //   139: athrow
    ...
    //   0	140	0	this	FindDeptSoapBindingStub
 ...
 * Qualified Name:     com.zte.eas.bmsctrl.ws.Fbdept_SC_CMS_00001.FindDeptSoapBindingStub
