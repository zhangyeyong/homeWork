  ...
  implements CreateImageSrv
{
  ...
  private static void _initOperationDesc1()
  {
    ...
    ParameterDesc localParameterDesc = new ParameterDesc(new QName("http://127.0.0.1/evs_ydzd", "request"), (byte)1, new QName("http://127.0.0.1/evs_ydzd", "CreateImageRequest"), CreateImageRequest.class, false, false);
    ...
    localOperationDesc.setReturnQName(new QName("http://127.0.0.1/evs_ydzd", "createImageReturn"));
    ...
    localParameterDesc = new ParameterDesc(new QName("http://127.0.0.1/evs_ydzd", "req"), (byte)1, new QName("http://127.0.0.1/evs_ydzd", "CreateImageRequest"), CreateImageRequest.class, false, false);
    localOperationDesc.addParameter(localParameterDesc);
    localOperationDesc.setReturnType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
    localOperationDesc.setReturnClass(String.class);
    localOperationDesc.setReturnQName(new QName("http://127.0.0.1/evs_ydzd", "deleteImageReturn"));
    localOperationDesc.setStyle(Style.DOCUMENT);
    localOperationDesc.setUse(Use.LITERAL);
    ...
    throws AxisFault
  {
    ...
    QName localQName1 = new QName("http://127.0.0.1/evs_ydzd", "ArrayOfImageList");
    this.cachedSerQNames.add(localQName1);
    Object localObject = [Lcom.zte.eas.bmsctrl.ws.BOE_SC_CMS_00002.ImageList.class;
    this.cachedSerClasses.add(localObject);
    localQName1 = new QName("http://127.0.0.1/evs_ydzd", "ImageList");
    QName localQName2 = new QName("http://127.0.0.1/evs_ydzd", "item");
    this.cachedSerFactories.add(new ArraySerializerFactory(localQName1, localQName2));
    this.cachedDeserFactories.add(new ArrayDeserializerFactory());
    localQName1 = new QName("http://127.0.0.1/evs_ydzd", "CreateImageRequest");
    this.cachedSerQNames.add(localQName1);
    ...
    throws RemoteException
  {
    ...
    //   14: athrow
    //   15: aload_0
    //   16: invokevirtual 96	com/zte/eas/bmsctrl/ws/BOE_SC_CMS_00002/CreateImageSrvSoapBindingStub:createCall	()Lorg/apache/axis/client/Call;
    //   19: astore_2
    //   20: aload_2
    //   21: getstatic 25	com/zte/eas/bmsctrl/ws/BOE_SC_CMS_00002/CreateImageSrvSoapBindingStub:_operations	[Lorg/apache/axis/description/OperationDesc;
    //   24: iconst_0
    //   25: aaload
    ...
    //   45: aload_2
    //   46: ldc 100
    //   48: getstatic 101	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   51: invokevirtual 79	org/apache/axis/client/Call:setProperty	(Ljava/lang/String;Ljava/lang/Object;)V
    //   54: aload_2
    //   55: ldc 102
    //   57: getstatic 101	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   60: invokevirtual 79	org/apache/axis/client/Call:setProperty	(Ljava/lang/String;Ljava/lang/Object;)V
    //   63: aload_2
    //   64: getstatic 103	org/apache/axis/soap/SOAPConstants:SOAP11_CONSTANTS	Lorg/apache/axis/soap/SOAP11Constants;
    //   67: invokevirtual 104	org/apache/axis/client/Call:setSOAPVersion	(Lorg/apache/axis/soap/SOAPConstants;)V
    //   70: aload_2
    ...
    //   85: aload_0
    //   86: aload_2
    //   87: invokevirtual 107	com/zte/eas/bmsctrl/ws/BOE_SC_CMS_00002/CreateImageSrvSoapBindingStub:setRequestHeaders	(Lorg/apache/axis/client/Call;)V
    //   90: aload_0
    //   91: aload_2
    //   92: invokevirtual 108	com/zte/eas/bmsctrl/ws/BOE_SC_CMS_00002/CreateImageSrvSoapBindingStub:setAttachments	(Lorg/apache/axis/client/Call;)V
    //   95: aload_2
    //   96: iconst_1
    ...
    //   120: aload_0
    //   121: aload_2
    //   122: invokevirtual 112	com/zte/eas/bmsctrl/ws/BOE_SC_CMS_00002/CreateImageSrvSoapBindingStub:extractAttachments	(Lorg/apache/axis/client/Call;)V
    //   125: aload_3
 ...
 * Qualified Name:     com.zte.eas.bmsctrl.ws.BOE_SC_CMS_00002.CreateImageSrvSoapBindingStub
