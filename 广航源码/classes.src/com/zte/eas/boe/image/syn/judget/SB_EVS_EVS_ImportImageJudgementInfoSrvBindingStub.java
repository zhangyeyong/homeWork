...
public class SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub
  extends Stub
  implements SB_EVS_EVS_ImportImageJudgementInfoSrv_PortType
{
  ...
  private static void _initOperationDesc1()
  {
    ...
    ParameterDesc localParameterDesc = new ParameterDesc(new QName("http://mss.cmcc.com/SB_EVS_EVS_ImportImageJudgementInfoSrv", "SB_EVS_EVS_ImportImageJudgementInfoSrvRequest"), (byte)1, new QName("http://mss.cmcc.com/SB_EVS_EVS_ImportImageJudgementInfoSrv", "SB_EVS_EVS_ImportImageJudgementInfoSrvRequest"), SB_EVS_EVS_ImportImageJudgementInfoSrvRequest.class, false, false);
    ...
    localOperationDesc.setReturnQName(new QName("http://mss.cmcc.com/SB_EVS_EVS_ImportImageJudgementInfoSrv", "SB_EVS_EVS_ImportImageJudgementInfoSrvResponse"));
    localOperationDesc.setStyle(Style.DOCUMENT);
    localOperationDesc.setUse(Use.LITERAL);
    _operations[0] = localOperationDesc;
  }
  
  public SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub()
    throws AxisFault
  {
    this(null);
  }
  
  public SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub(URL paramURL, javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    this(paramService);
  ...
  public SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub(javax.xml.rpc.Service paramService)
    throws AxisFault
  {
    ...
    Object localObject = [Lcom.zte.eas.boe.image.syn.judget.ErrorItem.class;
    ...
    this.cachedSerQNames.add(localQName1);
    localObject = [Lcom.zte.eas.boe.image.syn.judget.ResponseItem.class;
    this.cachedSerClasses.add(localObject);
    ...
    this.cachedSerFactories.add(localBeanSerializerFactory);
    this.cachedDeserFactories.add(localBeanDeserializerFactory);
    localQName1 = new QName("http://mss.cmcc.com/SB_EVS_EVS_ImportImageJudgementInfoSrv", "ImportImageJudgementInfoSrvInputCollection");
    this.cachedSerQNames.add(localQName1);
    localObject = [Lcom.zte.eas.boe.image.syn.judget.ImportImageJudgementInfoSrvInputItem.class;
    this.cachedSerClasses.add(localObject);
    localQName1 = new QName("http://mss.cmcc.com/SB_EVS_EVS_ImportImageJudgementInfoSrv", "ImportImageJudgementInfoSrvInputItem");
    localQName2 = new QName("http://mss.cmcc.com/SB_EVS_EVS_ImportImageJudgementInfoSrv", "ImportImageJudgementInfoSrvInputItem");
    this.cachedSerFactories.add(new ArraySerializerFactory(localQName1, localQName2));
    this.cachedDeserFactories.add(new ArrayDeserializerFactory());
    localQName1 = new QName("http://mss.cmcc.com/SB_EVS_EVS_ImportImageJudgementInfoSrv", "ImportImageJudgementInfoSrvInputItem");
    this.cachedSerQNames.add(localQName1);
    localObject = ImportImageJudgementInfoSrvInputItem.class;
    this.cachedSerClasses.add(localObject);
    this.cachedSerFactories.add(localBeanSerializerFactory);
    this.cachedDeserFactories.add(localBeanDeserializerFactory);
    localQName1 = new QName("http://mss.cmcc.com/SB_EVS_EVS_ImportImageJudgementInfoSrv", "SB_EVS_EVS_ImportImageJudgementInfoSrvRequest");
    this.cachedSerQNames.add(localQName1);
    localObject = SB_EVS_EVS_ImportImageJudgementInfoSrvRequest.class;
    this.cachedSerClasses.add(localObject);
    this.cachedSerFactories.add(localBeanSerializerFactory);
    this.cachedDeserFactories.add(localBeanDeserializerFactory);
  }
    ...
    throws RemoteException
  {
    ...
    //   14: athrow
    //   15: aload_0
    //   16: invokevirtual 103	com/zte/eas/boe/image/syn/judget/SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub:createCall	()Lorg/apache/axis/client/Call;
    //   19: astore_2
    //   20: aload_2
    //   21: getstatic 24	com/zte/eas/boe/image/syn/judget/SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub:_operations	[Lorg/apache/axis/description/OperationDesc;
    //   24: iconst_0
    //   25: aaload
    ...
    //   85: aload_0
    //   86: aload_2
    //   87: invokevirtual 113	com/zte/eas/boe/image/syn/judget/SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub:setRequestHeaders	(Lorg/apache/axis/client/Call;)V
    //   90: aload_0
    //   91: aload_2
    //   92: invokevirtual 114	com/zte/eas/boe/image/syn/judget/SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub:setAttachments	(Lorg/apache/axis/client/Call;)V
    //   95: aload_2
    //   96: iconst_1
    ...
    //   120: aload_0
    //   121: aload_2
    //   122: invokevirtual 118	com/zte/eas/boe/image/syn/judget/SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub:extractAttachments	(Lorg/apache/axis/client/Call;)V
    //   125: aload_3
    //   126: checkcast 16	com/zte/eas/boe/image/syn/judget/ImportSrvResponse
    //   129: areturn
    //   130: astore 4
    //   132: aload_3
    //   133: ldc_w 16
    //   136: invokestatic 120	org/apache/axis/utils/JavaUtils:convert	(Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;
    //   139: checkcast 16	com/zte/eas/boe/image/syn/judget/ImportSrvResponse
    //   142: areturn
    //   143: astore_3
    //   144: aload_3
    //   145: athrow
    ...
    //   0	146	0	this	SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub
    //   0	146	1	paramSB_EVS_EVS_ImportImageJudgementInfoSrvRequest	SB_EVS_EVS_ImportImageJudgementInfoSrvRequest
 ...
 * Qualified Name:     com.zte.eas.boe.image.syn.judget.SB_EVS_EVS_ImportImageJudgementInfoSrvBindingStub
