...
public class FI_FA_ImportAssetRetirmentSrvPortClient
{
  private FI_FA_ImportAssetRetirmentSrv_PortType _port;
  
  public FI_FA_ImportAssetRetirmentSrvPortClient()
    throws Exception
  {
    ServiceFactory localServiceFactory = ServiceFactory.newInstance();
    this._port = ((FI_FA_ImportAssetRetirmentSrv_Service)localServiceFactory.loadService(FI_FA_ImportAssetRetirmentSrv_Service.class)).getFI_FA_ImportAssetRetirmentSrvPort();
  }
  ...
  public static void main(String[] paramArrayOfString)
  {
    try
    {
      ...
      System.out.println("calling " + localFI_FA_ImportAssetRetirmentSrvPortClient.getEndpoint());
    }
  ...
  {
    return this._port.process(paramFI_FA_ImportAssetRetirmentSrvProcessRequest);
  }
  
  public FI_FA_ImportAssetRetirmentSrv_PortType getPort()
  {
    return this._port;
  }
 ...
 * Qualified Name:     com.zte.eas.appframe.importmis.assetgarbage.FI_FA_ImportAssetRetirmentSrvPortClient
