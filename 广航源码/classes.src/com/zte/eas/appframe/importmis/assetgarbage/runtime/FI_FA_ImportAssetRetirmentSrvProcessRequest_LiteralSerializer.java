...
public class FI_FA_ImportAssetRetirmentSrvProcessRequest_LiteralSerializer
  extends LiteralObjectSerializerBase
  implements Initializable
{
  private static final QName ns1_LineIds_QNAME = new QName("http://eas.zte.com.cn/all/FI_FA_ImportAssetRetirmentSrv", "LineIds");
  private static final QName ns1_LineIDCollection_TYPE_QNAME = new QName("http://eas.zte.com.cn/all/FI_FA_ImportAssetRetirmentSrv", "LineIDCollection");
  private CombinedSerializer myns1_LineIDCollection__LineIDCollection_LiteralSerializer;
  private static final QName ns1_EmployeeNumber_QNAME = new QName("http://eas.zte.com.cn/all/FI_FA_ImportAssetRetirmentSrv", "EmployeeNumber");
  private static final QName ns2_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
  private CombinedSerializer myns2_string__java_lang_String_String_Serializer;
  
  public FI_FA_ImportAssetRetirmentSrvProcessRequest_LiteralSerializer(QName paramQName)
  {
    this(paramQName, false);
  }
  
  public FI_FA_ImportAssetRetirmentSrvProcessRequest_LiteralSerializer(QName paramQName, boolean paramBoolean)
  {
    ...
    throws Exception
  {
    ...
    for (int i = 0; i < 2; i++)
    {
      ...
      if (matchQName(localQName, ns1_EmployeeNumber_QNAME))
      {
        ...
        localFI_FA_ImportAssetRetirmentSrvProcessRequest.setEmployeeNumber((String)localObject);
        paramSOAPDeserializationContext.setXmlFragmentWrapperName(null);
        paramXMLReader.nextElementContent();
      }
    }
    ...
    return localFI_FA_ImportAssetRetirmentSrvProcessRequest;
  }
  ...
  public void doSerializeAttributes(Object paramObject, XMLWriter paramXMLWriter, SOAPSerializationContext paramSOAPSerializationContext)
    throws Exception
  {
    FI_FA_ImportAssetRetirmentSrvProcessRequest localFI_FA_ImportAssetRetirmentSrvProcessRequest = (FI_FA_ImportAssetRetirmentSrvProcessRequest)paramObject;
  }
    ...
    throws Exception
  {
    FI_FA_ImportAssetRetirmentSrvProcessRequest localFI_FA_ImportAssetRetirmentSrvProcessRequest = (FI_FA_ImportAssetRetirmentSrvProcessRequest)paramObject;
    this.myns1_LineIDCollection__LineIDCollection_LiteralSerializer.setNullable(false);
    this.myns1_LineIDCollection__LineIDCollection_LiteralSerializer.serialize(localFI_FA_ImportAssetRetirmentSrvProcessRequest.getLineIds(), ns1_LineIds_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
    this.myns2_string__java_lang_String_String_Serializer.setNullable(false);
    this.myns2_string__java_lang_String_String_Serializer.serialize(localFI_FA_ImportAssetRetirmentSrvProcessRequest.getEmployeeNumber(), ns1_EmployeeNumber_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
  }
}


/* Location:           C:\Users\zhangyeyong\Downloads\gdc_evs\evs\webapps\evs\WEB-INF\classes\
 * Qualified Name:     com.zte.eas.appframe.importmis.assetgarbage.runtime.FI_FA_ImportAssetRetirmentSrvProcessRequest_LiteralSerializer
