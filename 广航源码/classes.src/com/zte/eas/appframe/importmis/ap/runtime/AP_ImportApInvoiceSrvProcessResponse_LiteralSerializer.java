...
public class AP_ImportApInvoiceSrvProcessResponse_LiteralSerializer
  extends LiteralObjectSerializerBase
  implements Initializable
{
  private static final QName ns1_ErrorFlag_QNAME = new QName("http://eas.zte.com.cn/all/AP_ImportApInvoiceSrv", "ErrorFlag");
  private static final QName ns2_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
  private CombinedSerializer myns2_string__java_lang_String_String_Serializer;
  private static final QName ns1_ErrorMessage_QNAME = new QName("http://eas.zte.com.cn/all/AP_ImportApInvoiceSrv", "ErrorMessage");
  
  public AP_ImportApInvoiceSrvProcessResponse_LiteralSerializer(QName paramQName)
  {
    this(paramQName, false);
  }
  
  public AP_ImportApInvoiceSrvProcessResponse_LiteralSerializer(QName paramQName, boolean paramBoolean)
  {
  ...
  public Object doDeserialize(XMLReader paramXMLReader, SOAPDeserializationContext paramSOAPDeserializationContext)
    throws Exception
  {
    AP_ImportApInvoiceSrvProcessResponse localAP_ImportApInvoiceSrvProcessResponse = new AP_ImportApInvoiceSrvProcessResponse();
    ...
    for (int i = 0; i < 2; i++)
    {
      ...
      if (matchQName(localQName, ns1_ErrorFlag_QNAME))
      {
        ...
        localAP_ImportApInvoiceSrvProcessResponse.setErrorFlag((String)localObject);
      ...
      if (matchQName(localQName, ns1_ErrorMessage_QNAME))
      {
        ...
        localAP_ImportApInvoiceSrvProcessResponse.setErrorMessage((String)localObject);
        paramSOAPDeserializationContext.setXmlFragmentWrapperName(null);
        paramXMLReader.nextElementContent();
      }
    }
  ...
  public void doSerializeAttributes(Object paramObject, XMLWriter paramXMLWriter, SOAPSerializationContext paramSOAPSerializationContext)
    throws Exception
  {
    AP_ImportApInvoiceSrvProcessResponse localAP_ImportApInvoiceSrvProcessResponse = (AP_ImportApInvoiceSrvProcessResponse)paramObject;
  }
    ...
    throws Exception
  {
    AP_ImportApInvoiceSrvProcessResponse localAP_ImportApInvoiceSrvProcessResponse = (AP_ImportApInvoiceSrvProcessResponse)paramObject;
    this.myns2_string__java_lang_String_String_Serializer.setNullable(false);
    this.myns2_string__java_lang_String_String_Serializer.serialize(localAP_ImportApInvoiceSrvProcessResponse.getErrorFlag(), ns1_ErrorFlag_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
    this.myns2_string__java_lang_String_String_Serializer.setNullable(false);
    this.myns2_string__java_lang_String_String_Serializer.serialize(localAP_ImportApInvoiceSrvProcessResponse.getErrorMessage(), ns1_ErrorMessage_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
  }
}


/* Location:           C:\Users\zhangyeyong\Downloads\gdc_evs\evs\webapps\evs\WEB-INF\classes\
 * Qualified Name:     com.zte.eas.appframe.importmis.ap.runtime.AP_ImportApInvoiceSrvProcessResponse_LiteralSerializer
