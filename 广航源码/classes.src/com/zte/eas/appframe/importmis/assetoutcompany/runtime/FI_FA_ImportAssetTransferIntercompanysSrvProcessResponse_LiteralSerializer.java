...
public class FI_FA_ImportAssetTransferIntercompanysSrvProcessResponse_LiteralSerializer
  extends LiteralObjectSerializerBase
  implements Initializable
{
  private static final QName ns1_ErrorFlag_QNAME = new QName("http://eas.zte.com.cn/all/FI_FA_ImportAssetTransferIntercompanysSrv", "ErrorFlag");
  private static final QName ns2_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
  private CombinedSerializer myns2_string__java_lang_String_String_Serializer;
  private static final QName ns1_ErrorMessage_QNAME = new QName("http://eas.zte.com.cn/all/FI_FA_ImportAssetTransferIntercompanysSrv", "ErrorMessage");
  
  public FI_FA_ImportAssetTransferIntercompanysSrvProcessResponse_LiteralSerializer(QName paramQName)
  {
    this(paramQName, false);
  }
  
  public FI_FA_ImportAssetTransferIntercompanysSrvProcessResponse_LiteralSerializer(QName paramQName, boolean paramBoolean)
  {
  ...
  public Object doDeserialize(XMLReader paramXMLReader, SOAPDeserializationContext paramSOAPDeserializationContext)
    throws Exception
  {
    FI_FA_ImportAssetTransferIntercompanysSrvProcessResponse localFI_FA_ImportAssetTransferIntercompanysSrvProcessResponse = new FI_FA_ImportAssetTransferIntercompanysSrvProcessResponse();
    ...
    for (int i = 0; i < 2; i++)
    {
      ...
      if (matchQName(localQName, ns1_ErrorFlag_QNAME))
      {
        ...
        localFI_FA_ImportAssetTransferIntercompanysSrvProcessResponse.setErrorFlag((String)localObject);
      ...
      if (matchQName(localQName, ns1_ErrorMessage_QNAME))
      {
        ...
        localFI_FA_ImportAssetTransferIntercompanysSrvProcessResponse.setErrorMessage((String)localObject);
        paramSOAPDeserializationContext.setXmlFragmentWrapperName(null);
        paramXMLReader.nextElementContent();
      }
    }
  ...
  public void doSerializeAttributes(Object paramObject, XMLWriter paramXMLWriter, SOAPSerializationContext paramSOAPSerializationContext)
    throws Exception
  {
    FI_FA_ImportAssetTransferIntercompanysSrvProcessResponse localFI_FA_ImportAssetTransferIntercompanysSrvProcessResponse = (FI_FA_ImportAssetTransferIntercompanysSrvProcessResponse)paramObject;
  }
    ...
    throws Exception
  {
    FI_FA_ImportAssetTransferIntercompanysSrvProcessResponse localFI_FA_ImportAssetTransferIntercompanysSrvProcessResponse = (FI_FA_ImportAssetTransferIntercompanysSrvProcessResponse)paramObject;
    this.myns2_string__java_lang_String_String_Serializer.setNullable(false);
    this.myns2_string__java_lang_String_String_Serializer.serialize(localFI_FA_ImportAssetTransferIntercompanysSrvProcessResponse.getErrorFlag(), ns1_ErrorFlag_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
    this.myns2_string__java_lang_String_String_Serializer.setNullable(false);
    this.myns2_string__java_lang_String_String_Serializer.serialize(localFI_FA_ImportAssetTransferIntercompanysSrvProcessResponse.getErrorMessage(), ns1_ErrorMessage_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
  }
}


/* Location:           C:\Users\zhangyeyong\Downloads\gdc_evs\evs\webapps\evs\WEB-INF\classes\
 * Qualified Name:     com.zte.eas.appframe.importmis.assetoutcompany.runtime.FI_FA_ImportAssetTransferIntercompanysSrvProcessResponse_LiteralSerializer
