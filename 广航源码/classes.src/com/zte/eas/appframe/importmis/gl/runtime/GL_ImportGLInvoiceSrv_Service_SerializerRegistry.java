...
public class GL_ImportGLInvoiceSrv_Service_SerializerRegistry
  ...
  implements SerializerConstants
{
  public TypeMappingRegistry getRegistry()
  {
    ...
    Object localObject1 = new QName("http://eas.zte.com.cn/all/GL_ImportGLInvoiceSrv", "GL_ImportGLInvoiceSrvProcessResponse");
    Object localObject2 = new GL_ImportGLInvoiceSrvProcessResponse_LiteralSerializer((QName)localObject1, false);
    registerSerializer(localTypeMapping2, GL_ImportGLInvoiceSrvProcessResponse.class, (QName)localObject1, (Serializer)localObject2);
    localObject1 = new QName("http://eas.zte.com.cn/all/GL_ImportGLInvoiceSrv", "GL_ImportGLInvoiceSrvProcessRequest");
    localObject2 = new GL_ImportGLInvoiceSrvProcessRequest_LiteralSerializer((QName)localObject1, false);
    registerSerializer(localTypeMapping2, GL_ImportGLInvoiceSrvProcessRequest.class, (QName)localObject1, (Serializer)localObject2);
    localObject1 = new GL_ImportGLInvoiceSrv_Service_SerializerRegistry12();
    return ((GL_ImportGLInvoiceSrv_Service_SerializerRegistry12)localObject1).getRegistry(localTypeMappingRegistry);
  }
 ...
 * Qualified Name:     com.zte.eas.appframe.importmis.gl.runtime.GL_ImportGLInvoiceSrv_Service_SerializerRegistry
