...
public class GL_ImportGLInvoiceSrvProcessResponse_LiteralSerializer
  extends LiteralObjectSerializerBase
  implements Initializable
{
  private static final QName ns1_ErrorFlag_QNAME = new QName("http://eas.zte.com.cn/all/GL_ImportGLInvoiceSrv", "ErrorFlag");
  private static final QName ns2_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
  private CombinedSerializer myns2_string__java_lang_String_String_Serializer;
  private static final QName ns1_ErrorMessage_QNAME = new QName("http://eas.zte.com.cn/all/GL_ImportGLInvoiceSrv", "ErrorMessage");
  
  public GL_ImportGLInvoiceSrvProcessResponse_LiteralSerializer(QName paramQName)
  {
    this(paramQName, false);
  }
  
  public GL_ImportGLInvoiceSrvProcessResponse_LiteralSerializer(QName paramQName, boolean paramBoolean)
  {
  ...
  public Object doDeserialize(XMLReader paramXMLReader, SOAPDeserializationContext paramSOAPDeserializationContext)
    throws Exception
  {
    GL_ImportGLInvoiceSrvProcessResponse localGL_ImportGLInvoiceSrvProcessResponse = new GL_ImportGLInvoiceSrvProcessResponse();
    ...
    for (int i = 0; i < 2; i++)
    {
      ...
      if (matchQName(localQName, ns1_ErrorFlag_QNAME))
      {
        ...
        localGL_ImportGLInvoiceSrvProcessResponse.setErrorFlag((String)localObject);
      ...
      if (matchQName(localQName, ns1_ErrorMessage_QNAME))
      {
        ...
        localGL_ImportGLInvoiceSrvProcessResponse.setErrorMessage((String)localObject);
        paramSOAPDeserializationContext.setXmlFragmentWrapperName(null);
        paramXMLReader.nextElementContent();
      }
    }
  ...
  public void doSerializeAttributes(Object paramObject, XMLWriter paramXMLWriter, SOAPSerializationContext paramSOAPSerializationContext)
    throws Exception
  {
    GL_ImportGLInvoiceSrvProcessResponse localGL_ImportGLInvoiceSrvProcessResponse = (GL_ImportGLInvoiceSrvProcessResponse)paramObject;
  }
    ...
    throws Exception
  {
    GL_ImportGLInvoiceSrvProcessResponse localGL_ImportGLInvoiceSrvProcessResponse = (GL_ImportGLInvoiceSrvProcessResponse)paramObject;
    this.myns2_string__java_lang_String_String_Serializer.setNullable(false);
    this.myns2_string__java_lang_String_String_Serializer.serialize(localGL_ImportGLInvoiceSrvProcessResponse.getErrorFlag(), ns1_ErrorFlag_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
    this.myns2_string__java_lang_String_String_Serializer.setNullable(false);
    this.myns2_string__java_lang_String_String_Serializer.serialize(localGL_ImportGLInvoiceSrvProcessResponse.getErrorMessage(), ns1_ErrorMessage_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
  }
}


/* Location:           C:\Users\zhangyeyong\Downloads\gdc_evs\evs\webapps\evs\WEB-INF\classes\
 * Qualified Name:     com.zte.eas.appframe.importmis.gl.runtime.GL_ImportGLInvoiceSrvProcessResponse_LiteralSerializer
