...
public class FI_AR_ImportARTransactionSrvBinding_Stub
  extends StubBase
  implements FI_AR_ImportARTransactionSrv_PortType
{
  private static final QName _portName = new QName("http://xmlns.oracle.com/FI_AR_ImportARTransactionSrv", "FI_AR_ImportARTransactionSrvPort");
  private static final int process_OPCODE = 0;
  private static final QName ns1_process_FiArImportARTransactionSrvRequest_QNAME = new QName("http://eas.zte.com/ArImport/FiArImportARTransactionSrv", "FiArImportARTransactionSrvRequest");
  private static final QName ns1_FiArImportARTransactionSrvRequest_TYPE_QNAME = new QName("http://eas.zte.com/ArImport/FiArImportARTransactionSrv", "FiArImportARTransactionSrvRequest");
  private CombinedSerializer myns1_FiArImportARTransactionSrvRequest__FiArImportARTransactionSrvRequest_LiteralSerializer;
  private static final QName ns1_process_FiArImportARTransactionSrvResponse_QNAME = new QName("http://eas.zte.com/ArImport/FiArImportARTransactionSrv", "FiArImportARTransactionSrvResponse");
  private static final QName ns1_FiArImportARTransactionSrvResponse_TYPE_QNAME = new QName("http://eas.zte.com/ArImport/FiArImportARTransactionSrv", "FiArImportARTransactionSrvResponse");
  private CombinedSerializer myns1_FiArImportARTransactionSrvResponse__FiArImportARTransactionSrvResponse_LiteralSerializer;
  private static final String[] myNamespace_declarations = { "ns0", "http://eas.zte.com/ArImport/FiArImportARTransactionSrv" };
  private static final QName[] understoodHeaderNames = new QName[0];
  
  public FI_AR_ImportARTransactionSrvBinding_Stub(HandlerChain paramHandlerChain)
  {
    super(paramHandlerChain);
    _setProperty("javax.xml.rpc.service.endpoint.address", AccessPropertiesFile.getValue("arv_import"));
    setSoapVersion(SOAPVersion.SOAP_11);
    setServiceName(new QName("http://xmlns.oracle.com/FI_AR_ImportARTransactionSrv", "FI_AR_ImportARTransactionSrv"));
    setPortName(new QName("http://xmlns.oracle.com/FI_AR_ImportARTransactionSrv", "FI_AR_ImportARTransactionSrvPort"));
    setupConfig("com/zte/eas/appframe/importmis/arv/runtime/FI_AR_ImportARTransactionSrvBinding_Stub.xml");
  }
    ...
    throws RemoteException
  {
    ...
    try
    {
      ...
      SOAPBlockInfo localSOAPBlockInfo = new SOAPBlockInfo(ns1_process_FiArImportARTransactionSrvRequest_QNAME);
      localSOAPBlockInfo.setValue(paramFiArImportARTransactionSrvRequest);
      localSOAPBlockInfo.setSerializer(this.myns1_FiArImportARTransactionSrvRequest__FiArImportARTransactionSrvRequest_LiteralSerializer);
      ...
      FiArImportARTransactionSrvResponse localFiArImportARTransactionSrvResponse = null;
      ...
      if ((localObject instanceof SOAPDeserializationState)) {
        localFiArImportARTransactionSrvResponse = (FiArImportARTransactionSrvResponse)((SOAPDeserializationState)localObject).getInstance();
      } else {
        localFiArImportARTransactionSrvResponse = (FiArImportARTransactionSrvResponse)localObject;
      }
    ...
    throws Exception
  {
    try
    {
      Object localObject = this.myns1_FiArImportARTransactionSrvResponse__FiArImportARTransactionSrvResponse_LiteralSerializer.deserialize(ns1_process_FiArImportARTransactionSrvResponse_QNAME, paramXMLReader, paramSOAPDeserializationContext);
      SOAPBlockInfo localSOAPBlockInfo = new SOAPBlockInfo(ns1_process_FiArImportARTransactionSrvResponse_QNAME);
    ...
    throws Exception
  {
    ...
    this.myns1_FiArImportARTransactionSrvRequest__FiArImportARTransactionSrvRequest_LiteralSerializer = ((CombinedSerializer)paramInternalTypeMappingRegistry.getSerializer("", FiArImportARTransactionSrvRequest.class, ns1_FiArImportARTransactionSrvRequest_TYPE_QNAME));
    this.myns1_FiArImportARTransactionSrvResponse__FiArImportARTransactionSrvResponse_LiteralSerializer = ((CombinedSerializer)paramInternalTypeMappingRegistry.getSerializer("", FiArImportARTransactionSrvResponse.class, ns1_FiArImportARTransactionSrvResponse_TYPE_QNAME));
  }
}


/* Location:           C:\Users\zhangyeyong\Downloads\gdc_evs\evs\webapps\evs\WEB-INF\classes\
 * Qualified Name:     com.zte.eas.appframe.importmis.arv.runtime.FI_AR_ImportARTransactionSrvBinding_Stub
