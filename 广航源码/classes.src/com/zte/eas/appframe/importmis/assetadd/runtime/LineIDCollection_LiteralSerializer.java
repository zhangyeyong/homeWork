...
{
  private static final QName ns1_LineIDItem_QNAME = new QName("http://eas.zte.com.cn/all/FI_FA_ImportAssetMassAddtionSrv", "LineIDItem");
  private static final QName ns1_LineIDItem_TYPE_QNAME = new QName("http://eas.zte.com.cn/all/FI_FA_ImportAssetMassAddtionSrv", "LineIDItem");
    ...
    throws Exception
  {
    ...
    else if (paramXMLReader.getState() == 2) {}
 ...
 * Qualified Name:     com.zte.eas.appframe.importmis.assetadd.runtime.LineIDCollection_LiteralSerializer
