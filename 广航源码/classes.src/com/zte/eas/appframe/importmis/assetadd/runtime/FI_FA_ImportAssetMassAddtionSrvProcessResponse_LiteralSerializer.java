...
public class FI_FA_ImportAssetMassAddtionSrvProcessResponse_LiteralSerializer
  extends LiteralObjectSerializerBase
  implements Initializable
{
  private static final QName ns1_ErrorFlag_QNAME = new QName("http://eas.zte.com.cn/all/FI_FA_ImportAssetMassAddtionSrv", "ErrorFlag");
  private static final QName ns2_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
  private CombinedSerializer myns2_string__java_lang_String_String_Serializer;
  private static final QName ns1_ErrorMessage_QNAME = new QName("http://eas.zte.com.cn/all/FI_FA_ImportAssetMassAddtionSrv", "ErrorMessage");
  
  public FI_FA_ImportAssetMassAddtionSrvProcessResponse_LiteralSerializer(QName paramQName)
  {
    this(paramQName, false);
  }
  
  public FI_FA_ImportAssetMassAddtionSrvProcessResponse_LiteralSerializer(QName paramQName, boolean paramBoolean)
  {
  ...
  public Object doDeserialize(XMLReader paramXMLReader, SOAPDeserializationContext paramSOAPDeserializationContext)
    throws Exception
  {
    FI_FA_ImportAssetMassAddtionSrvProcessResponse localFI_FA_ImportAssetMassAddtionSrvProcessResponse = new FI_FA_ImportAssetMassAddtionSrvProcessResponse();
    ...
    for (int i = 0; i < 2; i++)
    {
      ...
      if (matchQName(localQName, ns1_ErrorFlag_QNAME))
      {
        ...
        localFI_FA_ImportAssetMassAddtionSrvProcessResponse.setErrorFlag((String)localObject);
      ...
      if (matchQName(localQName, ns1_ErrorMessage_QNAME))
      {
        ...
        localFI_FA_ImportAssetMassAddtionSrvProcessResponse.setErrorMessage((String)localObject);
        paramSOAPDeserializationContext.setXmlFragmentWrapperName(null);
        paramXMLReader.nextElementContent();
      }
    }
  ...
  public void doSerializeAttributes(Object paramObject, XMLWriter paramXMLWriter, SOAPSerializationContext paramSOAPSerializationContext)
    throws Exception
  {
    FI_FA_ImportAssetMassAddtionSrvProcessResponse localFI_FA_ImportAssetMassAddtionSrvProcessResponse = (FI_FA_ImportAssetMassAddtionSrvProcessResponse)paramObject;
  }
    ...
    throws Exception
  {
    FI_FA_ImportAssetMassAddtionSrvProcessResponse localFI_FA_ImportAssetMassAddtionSrvProcessResponse = (FI_FA_ImportAssetMassAddtionSrvProcessResponse)paramObject;
    this.myns2_string__java_lang_String_String_Serializer.setNullable(false);
    this.myns2_string__java_lang_String_String_Serializer.serialize(localFI_FA_ImportAssetMassAddtionSrvProcessResponse.getErrorFlag(), ns1_ErrorFlag_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
    this.myns2_string__java_lang_String_String_Serializer.setNullable(false);
    this.myns2_string__java_lang_String_String_Serializer.serialize(localFI_FA_ImportAssetMassAddtionSrvProcessResponse.getErrorMessage(), ns1_ErrorMessage_QNAME, null, paramXMLWriter, paramSOAPSerializationContext);
  }
}


/* Location:           C:\Users\zhangyeyong\Downloads\gdc_evs\evs\webapps\evs\WEB-INF\classes\
 * Qualified Name:     com.zte.eas.appframe.importmis.assetadd.runtime.FI_FA_ImportAssetMassAddtionSrvProcessResponse_LiteralSerializer
