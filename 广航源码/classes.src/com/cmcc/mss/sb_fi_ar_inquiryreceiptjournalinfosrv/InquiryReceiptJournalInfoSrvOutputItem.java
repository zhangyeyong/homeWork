...
@XmlType(name="InquiryReceiptJournalInfoSrvOutputItem", propOrder={"orgid", "orgname", "setofbooks", "periodname", "customernumber", "customername", "address", "headerid", "journalnum", "journalname", "journaltype", "receiptnumber", "boenum", "currencycode", "sourcecode", "orgcharge", "username", "createddate", "accountingdate", "approver", "approveddate", "attachmentnum", "lastupdatedate", "oreserved1", "oreserved2", "oreserved3", "oreserved4", "oreserved5", "oreserved6", "oreserved7", "oreserved8", "oreserved9", "oreserved10", "journalaccountinginfo"})
public class InquiryReceiptJournalInfoSrvOutputItem
{
  ...
  @XmlElement(name="CUSTOMER_NUMBER", required=true, nillable=true)
  protected String customernumber;
  @XmlElement(name="CUSTOMER_NAME", required=true, nillable=true)
  ...
  @XmlElement(name="RECEIPT_NUMBER", required=true, nillable=true)
 ...
 * Qualified Name:     com.cmcc.mss.sb_fi_ar_inquiryreceiptjournalinfosrv.InquiryReceiptJournalInfoSrvOutputItem
