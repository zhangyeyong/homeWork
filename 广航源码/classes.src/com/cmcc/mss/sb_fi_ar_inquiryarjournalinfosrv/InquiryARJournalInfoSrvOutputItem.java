...
@XmlType(name="InquiryARJournalInfoSrvOutputItem", propOrder={"orgid", "orgname", "setofbooks", "periodname", "customernumber", "customername", "address", "headerid", "journalnum", "journalname", "journaltype", "transactionnum", "boenum", "currencycode", "source", "sourcecode", "orgcharge", "createdby", "createddate", "accountingdate", "approver", "approveddate", "attachmentnum", "lastupdatedate", "oreserved1", "oreserved2", "oreserved3", "oreserved4", "oreserved5", "oreserved6", "oreserved7", "oreserved8", "oreserved9", "oreserved10", "journalaccountinginfo"})
public class InquiryARJournalInfoSrvOutputItem
{
  ...
  @XmlElement(name="TRANSACTION_NUM", required=true, nillable=true)
 ...
 * Qualified Name:     com.cmcc.mss.sb_fi_ar_inquiryarjournalinfosrv.InquiryARJournalInfoSrvOutputItem
