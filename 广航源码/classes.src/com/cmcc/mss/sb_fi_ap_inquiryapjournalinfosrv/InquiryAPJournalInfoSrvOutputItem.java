...
@XmlType(name="InquiryAPJournalInfoSrvOutputItem", propOrder={"orgid", "orgname", "setofbooks", "periodname", "vendornumber", "vendorname", "vendorsitecode", "headerid", "journalnum", "journalname", "journaltype", "eventtypename", "batchname", "invoiceid", "invoicenum", "boenum", "currencycode", "source", "sourcecode", "orgcharge", "createdby", "createddate", "accountingdate", "approver", "approveddate", "attachmentnum", "lastupdatedate", "oreserved1", "oreserved2", "oreserved3", "oreserved4", "oreserved5", "oreserved6", "oreserved7", "oreserved8", "oreserved9", "oreserved10", "journalaccountinginfo"})
public class InquiryAPJournalInfoSrvOutputItem
{
  ...
  @XmlElement(name="EVENT_TYPE_NAME", required=true, nillable=true)
  protected String eventtypename;
  @XmlElement(name="BATCH_NAME", required=true, nillable=true)
  protected String batchname;
  @XmlElement(name="INVOICE_ID", required=true, nillable=true)
  protected BigDecimal invoiceid;
  @XmlElement(name="INVOICE_NUM", required=true, nillable=true)
  ...
  public void setINVOICEID(BigDecimal paramBigDecimal)
  {
    this.invoiceid = paramBigDecimal;
  }
 ...
 * Qualified Name:     com.cmcc.mss.sb_fi_ap_inquiryapjournalinfosrv.InquiryAPJournalInfoSrvOutputItem
